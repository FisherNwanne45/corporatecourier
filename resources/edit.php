...
?>
                                            ...
                                            <div class="controls">
                                                ...
                                                <select name="rmk" id="rmk">
                                                    ...
                                                    <option value="Order Confirmed"
                                                        <?php if ($row['rmk'] == 'Order Confirmed') { echo 'selected'; } ?>>
                                                        Order Confirmed</option>

                                                    <option value="Picked by Courier"
                                                        <?php if ($row['rmk'] == 'Picked by Courier') { echo 'selected'; } ?>>
                                                        Picked by Courier</option>

                                                    <option value="On The Way"
                                                        <?php if ($row['rmk'] == 'On The Way') { echo 'selected'; } ?>>
                                                        On The Way</option>

                                                    <option value="Ready for Pickup"
                                                        <?php if ($row['rmk'] == 'Ready for Pickup') { echo 'selected'; } ?>>
                                                        Ready for Pickup</option>

                                                    <option value="Custom Hold"
                                                        <?php if ($row['rmk'] == 'Custom Hold') { echo 'selected'; } ?>>
                                                        Custom Hold</option>

                                                    <option value="Arrived"
                                                        <?php if ($row['rmk'] == 'Arrived') { echo 'selected'; } ?>>
                                                        Arrived</option>

                                                    <option value="Delivered"
                                                        <?php if ($row['rmk'] == 'Delivered') { echo 'selected'; } ?>>
                                                        Delivered</option>
                                                </select>
        ...
        <div class="footer">
            <div class="container">
                <b class="copyright">&copy; 2022 Fisher Designs </b>All rights reserved.
            </div>
        </div>

...
<html lang="en-US">
            ...
            <div class="page_wrap">
                                ...
                                <nav role="navigation" class="menu_main_nav_area">
                                    <ul id="menu_main" class="menu_main_nav">
                                        ...
                                        <li id="menu-item-3366"
                                            class="menu-item menu-item-type-post_type current-menu-item menu-item-object-page menu-item-3366">
                ...
                <section class="top_panel_image"
                    ...
                    <div class="top_panel_image_header">
                        ...
                        <h1 itemprop="name" class="top_panel_image_title entry-title">Our services</h1>
                        ...
                        <div class="breadcrumbs">
                            <span class="breadcrumbs_item_first">You Are Here:</span><a class="breadcrumbs_item home"
                                ...
                                class="breadcrumbs_item current">Our services</span>
                        </div>
                ...
                <div class="page_content_wrap">
                    ...
                    <div class="content_wrap">
                        <div class="content">
                            <article
                                class="itemscope post_item post_item_single post_featured_default post_format_standard post-3363 page type-page status-publish has-post-thumbnail hentry"
                                            ...
                                            <div class="vc_column-inner ">
                                                <div class="wpb_wrapper">
                                                    <div class="sc_section"
                                                        style="margin-top:3em !important;margin-bottom:6em !important;">
                                                        <div id="sc_blogger_587465998"
                                                            class="sc_blogger layout_news template_news  sc_blogger_horizontal">
                                                            <div class="columns_wrap">
                                                                <div class="column-1_3 column_item_1 odd first">

                                                                    <div
                                                                        class="post_item post_item_news sc_blogger_item">
                                                                        <div class="post_featured">
                                                                            <div class="post_thumb">
                                                                                <img class="wp-post-image" width="400"
                                                                                    height="250"
                                                                                    alt="Air Freight Forwarding"
                                                                                    src="wp-content/uploads/2015/06/globallogistics_2-400x250.jpg">
                                                                                <div class="hover_wrap">
                                                                                    <div class="link_wrap">
                                                                                        <a class="hover_link icon-link"
                                                                                            href="#"></a>
                                                                                        <a class="hover_view icon-resize-full"
                                                                        ...
                                                                        <h3
                                                                            class="post_title sc_title sc_blogger_title">
                                                                            Air Freight Forwarding</h3>
                                                                        <div class="post_content sc_blogger_content">
                                                                            <div class="post_descr">
                                                                                <p><?php echo $row['name']; ?>
                                                                                    specializes in
                                                                                    providing expert international air
                                                                                    freight forwarding services to
                                                                                    companies large and small. We are an
                                                                                    integral part of our clients export
                                                                                    departments, offering custom
                                                                                    tailored air freight logistics
                                                                                    solutions for a wide variety of
                                                                                    cargo. </p>
                                                                                <p></p><a href="contact.php"
                                                                                    class="sc_button sc_button_square sc_button_bg_underline  sc_button_iconed ">Contact
                                                                                    us<span
                                                                                        class="sc_button_iconed icon-right"></span></a>
                                                                            </div>
                                                                ...
                                                                <div class="column-1_3 column_item_2 even">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="post_featured">
                                                                            <div class="post_thumb">
                                                                                <img class="wp-post-image" width="400"
                                                                                    ...
                                                                                    src="wp-content/uploads/2015/07/globallogistics_21-400x250.jpg">
                                                                                <div class="hover_wrap">
                                                                                    <div class="link_wrap">
                                                                                        <a class="hover_link icon-link"
                                                                                            href="#"></a>
                                                                        ...
                                                                        <div class="post_content sc_blogger_content">
                                                                            <div class="post_descr">
                                                                                <p>Your supply chain needs to be secure,
                                                                                    resilient and well managed. No
                                                                                    matter how extensive or complex it
                                                                                    may be, we can help you achieve
                                                                                    excellent levels of security for it.
                                                                                    We can also share our knowledge in
                                                                                    managing supplier quality and
                                                                                    performance, environmental
                                                                                    responsibility, regulatory
                                                                                    compliance, forecasting and more –
                                                                                    transferring this expertise to you
                                                                                    so that you can deliver excellence
                                                                                    across your supply chain every day.
                                                                ...
                                                                <div class="column-1_3 column_item_3 odd">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="post_featured">
                                                                            <div class="post_thumb">
                                                                                <img class="wp-post-image" width="400"
                                                                                    height="250" alt="Road Transport"
                                                                                    src="wp-content/uploads/2015/07/globallogistics_10-400x250.jpg">
                                                                                <div class="hover_wrap">
                                                                                    <div class="link_wrap">
                                                                                        <a class="hover_link icon-link"
                                                                                            href="the-e-commerce-effect/index.php"></a>
                                                                                        <a class="hover_view icon-resize-full"
                                                                                            href="wp-content/uploads/2015/07/globallogistics_10.jpg"
                                                                                            title="Road Transport"></a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="post_content sc_blogger_content">
                                                                            <div class="post_descr">
                                                                                <p> When you need to move cargo
                                                                                    domestically or across the
                                                                                    continent, we can always find room
                                                                                    on one of our trucks. With traffic
                                                                                    hubs strategically located all over
                                                                                    Europe and 17,000 trucks on the road
                                                                                    every day, your cargo will be
                                                                                    delivered wherever and whenever
                                                                                    specified. The most common types of
                                                                                    road transport are:</p>
                                                                                <p>
                                                                                <ul>
                                                                                    <li>Full loads shipments</li>
                                                                                    <li>Part loads shipments</li>
                                                                                    <li>Groupage shipments</li>
                                                                                </ul>
                                                                                </p>
                                                                ...
                                                                <div class="column-1_3 column_item_4 even">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="post_featured">
                                                                            <div class="post_thumb">
                                                                                <img class="wp-post-image" width="400"
                                                                                    ...
                                                                                    src="wp-content/uploads/2015/07/globallogistics_25-400x250.jpg">
                                                                                <div class="hover_wrap">
                                                                                    <div class="link_wrap">
                                                                                        <a class="hover_link icon-link"
                                                                                            href="#"></a>
                                                                        ...
                                                                        <h3
                                                                            class="post_title sc_title sc_blogger_title">
                                                                            Ocean / Cargo Freight </h3>
                                                                        <div class="post_content sc_blogger_content">
                                                                            <div class="post_descr">
                                                                                <p><?php echo $row['name']; ?>
                                                                                    specializes in
                                                                                    providing expert international ocean
                                                                                    freight forwarding services to
                                                                                    companies large and small. We are an
                                                                                    integral part of our clients export
                                                                                    departments, offering custom
                                                                                    tailored ocean/sea freight logistics
                                                                                    solutions for a wide variety of
                                                                                    cargo.</p>
                                                                                <p>We offer all types of containerized
                                                                                    shipping, from less than container
                                                                                    loads to 20′, 40′ and refrigerated
                                                                                    containers. We also offer highly
                                                                                    personalized roll on roll off
                                                                                    services for cars, trucks and boats.
                                                                                    Our ocean shipping experts are
                                                                                    available to provide you with fast
                                                                                    quotes to all destinations across
                                                                                    the glove, no place is off limits to
                                                                                    AGL!</p>
                                                                                <a href="contact.php"
                                                                                    class="sc_button sc_button_square sc_button_bg_underline  sc_button_iconed ">Contact
                                                                                    Us<span
                                                                ...
                                                                <div class="column-1_3 column_item_5 odd">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="post_featured">
                                                                            <div class="post_thumb">
                                                                                <img class="wp-post-image" width="400"
                                                                                    ...
                                                                                    src="wp-content/uploads/2015/07/globallogistics_20-400x250.jpg">
                                                                                <div class="hover_wrap">
                                                                                    <div class="link_wrap">
                                                                                        <a class="hover_link icon-link"
                                                                                            href="#"></a>
                                                                        ...
                                                                        <h3
                                                                            class="post_title sc_title sc_blogger_title">
                                                                            Animal Transportation</h3>
                                                                        <div class="post_content sc_blogger_content">
                                                                            <div class="post_descr">
                                                                                <p>We were one of the first full service
                                                                                    pet/animal relocation specialists
                                                                                    and offer both domestic and global
                                                                                    services. Our network of highly
                                                                                    trained pet/animal handlers will
                                                                                    ensure the safe travel of your
                                                                                    family pet. We work hand in hand
                                                                                    with Moving and Relocation companies
                                                                                    in assisting their customers with
                                                                                    safe, trouble free transportation of
                                                                                    the most important aspect of their
                                                                                    relocation…the family pet! </p>

                                                                                <p><?php echo $row['name']; ?> has
                                                                                    over 20 years experience. We provide
                                                                                    top notch, state of the art
                                                                                    equipment, and experienced horsemen
                                                                                    who take great pride in giving your
                                                                                    horse the same love and care they
                                                                                    get at home. Our knowledgeable
                                                                                    drivers and friendly staff help to
                                                                                    set <?php echo $row['name']; ?>
                                                                                    Horse Transportation, apart to be
                                                                                    simply one of the best carriers in
                                                                                    the business. Ou Horse
                                                                                    Transportation Services, has built a
                                                                                    valued, lasting reputation within
                                                                                    the horse community as well as being
                                                                                    a respected member of the National
                                                                                    Horse Carriers Association.</p>
                                                                ...
                                                                <div class="column-1_3 column_item_6 even last">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="post_featured">
                                                                            <div class="post_thumb">
                                                                                <img class="wp-post-image" width="400"
                                                                                    height="250"
                                                                                    alt="Intermodal Roundtable"
                                                                                    src="wp-content/uploads/2015/07/globallogistics_26-400x250.jpg">
                                                                                <div class="hover_wrap">
                                                                                    <div class="link_wrap">
                                                                                        <a class="hover_link icon-link"
                                                                                            href="#"></a>
                                                                        ...
                                                                        <h3
                                                                            class="post_title sc_title sc_blogger_title">
                                                                            Warehousing / Storage </h3>
                                                                        <div class="post_content sc_blogger_content">
                                                                            <div class="post_descr">
                                                                                <p>We take pride in providing
                                                                                    exceptional products that will not
                                                                                    only streamline your business
                                                                                    process, but also save your
                                                                                    organization time and money. We have
                                                                                    high standards of performance, and
                                                                                    want you to know that when working
                                                                                    with AGL you can expect the be</p>
                                                                                <p>We provides third-party logistics and
                                                                                    warehousing services national and
                                                                                    internationally. We offers supply
                                                                                    chain services, including
                                                                                    warehousing and distribution; full
                                                                                    truckload, full truckload
                                                                                    multi-stop, LTL, ocean dray,
                                                                                    dedicated freight, local, home
                                                                                    delivery, flatbed, and bulk
                                                                                    transportation services; asset
                                                                                    management services; and civil
                                                                                    engineering and site development,
                                                                                    land surveying, embroidery and
                                                                                    screen printing, and consulting
                                                                                    services.</p>
                    ...
                    <div class="sc_gap">
                        <div class="sc_parallax bg_tint_light" style="color:#ffffff;" data-parallax-speed="0.6"
                            data-parallax-x-pos="50%" data-parallax-y-pos="50%">
                            <div class="sc_parallax_content"
                                style="background-image:url(wp-content/uploads/2015/07/parallax_bg.jpg); background-position:50% 50%;">
                                <div class="sc_parallax_overlay" style="background-color:rgba(36,59,78,0.8);"
                                    data-overlay="0.8" data-bg_color="#243b4e">
                                    <div class="sc_section aligncenter"
                                        style="margin-top:9em !important;margin-bottom:9em !important;">
                                        <h2 class="sc_title sc_title_underline sc_align_center"
                                            style="margin-top:0px;margin-bottom:17px;text-align:center;color:#ffffff;">
                                            The company promise</h2>
                                        <div class="wpb_text_column wpb_content_element ">
                                            <div class="wpb_wrapper">
                                                <p>As a contractor we promise to take care of all supply chain
                                                    management, to make your<br />
                    ...
                    <div class="content_wrap">
                        <div class="content">
                            ...
                            <!-- </article> class="itemscope post_item post_item_single post_featured_default post_format_standard post-3363 page type-page status-publish has-post-thumbnail hentry" itemscope itemtype="http://schema.org/Article"> -->
    ...
    <!-- Mirrored from www.corporatecouriersllc.com/services.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 23 Jul 2020 20:40:15 GMT -->
